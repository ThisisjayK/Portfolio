...
const OptionWheel = ({
  ...
  useEffect(
    () => () => {
      // Null the ref after cancelling: under React StrictMode the effect
      // cleanup runs once before the real mount, and if the id isn't cleared
      // the re-mounted startLoop() bails on its non-null guard and never
      // schedules a frame, leaving every option unpositioned.
