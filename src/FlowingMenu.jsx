...
function MenuItem({
  ...
  const marqueeLabel = marqueeText || text;
  // External links open in a new tab; in-app links (if any) navigate normally.
  const external = typeof link === 'string' && /^https?:/i.test(link);
